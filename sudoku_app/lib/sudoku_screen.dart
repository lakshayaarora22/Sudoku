...
*/
  ...
  Widget _buildSudokuBoard() {
    return Center(
      child: Column(
        children: [
          // Add the Text widget to display the elapsed time
          Text(
          ...
          Column(
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color:
                            isColoredCell ? _selectedColor : Colors.transparent,
                      ),
                      child: Center(
                        child: Text(
           ...
           Container(
            padding: const EdgeInsets.only(top: 20.0), // Adjust the bottom padding as needed
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                textStyle: const TextStyle(fontSize: 18), // Change the text size
              ),
